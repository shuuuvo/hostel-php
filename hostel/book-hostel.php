...
$emailid=$_POST['email'];
$query="insert into registration(roomno,seater,feespm,foodstatus,stayfrom,duration,regno,firstName,lastName,gender,contactno,emailid) values(?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisiisssis',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$regno,$fname,$lname,$gender,$contactno,$emailid);
$stmt->execute();
...
<input type="radio" value="1" name="foodstatus"> With Food(Tk. 2000.00 Extra)
</div>
</div>	
